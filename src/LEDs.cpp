...
uint8_t wordPositions[][2] PROGMEM = {
	{   0, 2 } /* ES    */, {  3, 3 } /* IST     */, {  7, 4 } /* FÜNF   */,
	{  18, 4 } /* ZEHN  */, { 11, 7 } /* ZWANZIG */,
	{  22, 4 } /* DREI  */, { 26, 7 } /* VIERTEL */,
	{  38, 4 } /* NACH  */, { 35, 3 } /* VOR     */,
	{  44, 4 } /* HALB  */, { 49, 5 } /* ZWÖLF   */,
	{  62, 4 } /* ZWEI  */, { 61, 3 } /* EIN    */, { 60, 4 } /* EINS    */, { 55, 6 } /* SIEBEN */,
	{  67, 4 } /* DREI  */, { 73, 4 } /* FÜNF    */,
	{  85, 3 } /* ELF   */, { 81, 4 } /* NEUN    */, { 77, 4 } /* VIER   */,
	{  89, 4 } /* ACHT  */, { 93, 4 } /* ZEHN    */,
	{ 104, 5 } /* SECHS */, { 99, 3 } /* UHR     */
};
...
void showGlyph(Glyph glyph) {
	for (uint8_t i = 0; i < NUM_LEDS; i++) {
		uint8_t x = getPosX(i); uint8_t y = getPosY(i);
		if (x >= NUM_COLS || y >= NUM_ROWS) { leds[i].nscale8(0); continue; }
